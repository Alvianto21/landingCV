		...
		<div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
			...
			<div class="bg-neutral-primary-soft block max-w-screen-md items-center p-6 border border-default rounded-base shadow-xs">
				...
				<ul class="flex space-x-4 sm:mt-0 mb-4">
                    <li>
                        <a href="{{ $links['x'] }}" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    ...
                    <li>
                        <a href="{{ $links['linkedin'] }}" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
